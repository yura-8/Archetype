...
namespace SimpleRpg
{
    ...
    /// </summary>
    public class SelectionItemUIController : MonoBehaviour, IBattleUIController
    {
        /// <summary>
        /// 説明テキストへの参照です。
        /// </summary>
        ...
        /// </summary>
        [SerializeField]
        SelectionItemController _controller_0;

        /// <summary>
        /// 2つ目の項目のコントローラへの参照です。
        /// </summary>
        [SerializeField]
        SelectionItemController _controller_1;

        /// <summary>
        /// 3つ目の項目のコントローラへの参照です。
        /// </summary>
        [SerializeField]
        SelectionItemController _controller_2;

        /// <summary>
        /// 4つ目の項目のコントローラへの参照です。
        /// </summary>
        [SerializeField]
        SelectionItemController _controller_3;
